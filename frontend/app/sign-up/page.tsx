        ...
        <div className="relative w-full max-w-md">
          <div className="glass p-6 md:p-8">
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl md:text-3xl font-black text-foreground mb-2">Create Account</h1>
              <p className="text-foreground/60 text-sm">Join thousands generating quality leads</p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div>
                <label className="block text-foreground text-sm font-semibold mb-2">Confirm Password</label>
                <input
                  type="password"
            ...
            <div className="mt-6 text-center">
              <p className="text-foreground/60 text-sm">
                ...
                <Link href="/sign-in" className="text-primary hover:text-primary/80 font-semibold transition">
                  Sign In
                </Link>
              </p>
            </div>
